...
class Main {
    public static final Map<String, Map<String, Object>> opts = [
            ...
            n: [longOpt: 'parent-view', required: true, args: 1, argName: 'parentView', description: "Parent View Name - gradle flag -DnestedView=<nestedView> - optional - must have Jenkins Nested View Plugin installed"],
